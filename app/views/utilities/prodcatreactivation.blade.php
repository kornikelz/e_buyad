    ...
    <div class="content-row">  
      ...
      <div class= "row">
        <div class="btn-group btn-group-justified">
          <a href="prodcatreactivation" class="btn btn-info">Product Category Data Reactivation</a>
          <a href="proddetreactivation" class="btn btn-primary">Product Details Data Reactivation</a>
        </div>
           ...
           <caption></caption>
            <thead>
              <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="First Name: activate to sort column ascending" style="width: 400px;">Category Name</th>
                  ...
                  <table id="example" class="table table-bordered table-hover">
                    ...
                    <thead>
                      <tr role="row">
                        ...
                        <th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Member ID: activate to sort column descending" style="width: 249px;">Category Code</th>
                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="First Name: activate to sort column ascending" style="width: 400px;">Category Code</th>
                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Option: activate to sort column ascending" style="width: 147px;">Description</th>
                      <tr>
                    </thead>
