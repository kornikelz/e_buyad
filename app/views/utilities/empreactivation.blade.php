    ...
    <div class="content-row">  
      ...
      <div class= "row">
        <div class="btn-group btn-group-justified">
          <a href="branchreactivation" class="btn btn-primary">Branch Details Data Reactivation</a>
          <a href="jobreactivation" class="btn btn-primary">Job Description Data Reactivation</a>
          <a href="empreactivation" class="btn btn-info">Employee Details Data Reactivation</a>
        </div>
           ...
           <caption></caption>
            <thead>
              <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Last Name: activate to sort column descending" style="width: 249px;">Middle Name</th>
                ...
                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Last Name: activate to sort column descending" style="width: 249px;">Address</th>
                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Last Name: activate to sort column descending" style="width: 249px;">Contact Number</th>
              </tr>
            </thead>
