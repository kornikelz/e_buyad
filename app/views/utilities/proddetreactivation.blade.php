    ...
    <div class="content-row">  
      ...
      <div class= "row">
        <div class="btn-group btn-group-justified">
          <a href="prodcatreactivation" class="btn btn-primary">Product Category Data Reactivation</a>
          <a href="proddetreactivation" class="btn btn-info">Product Details Data Reactivation</a>
        </div>
