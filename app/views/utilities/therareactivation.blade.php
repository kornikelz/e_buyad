    ...
    <div class="content-row">  
      ...
      <div class= "row">
        <div class="btn-group btn-group-justified">
          <a href="therareactivation" class="btn btn-info" style="font-size:15px">Therapeautic Data Reactivation</a>
          ...
          <a href="prodreactivation" class="btn btn-primary">Product Data Reactivation</a>
        </div>
