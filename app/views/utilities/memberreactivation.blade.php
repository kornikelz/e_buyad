...
@section('content')
  <div class="panel-body">
    <div class="content-row">  
      <center><h5 class="content-row-title" style="font-size:25px"><i class="glyphicon glyphicon-user"></i>&nbsp Member Data Reactivation
      <hr>
      </h5></center>
      
      <div class= "row">
        <div class="btn-group btn-group-justified">
          <a href="memberreactivation" class="btn btn-info">Member Data Reactivation</a>
        </div>
