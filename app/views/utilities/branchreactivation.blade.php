...
@section('content')
  <div class="panel-body">
    <div class="content-row">  
      <center><h5 class="content-row-title" style="font-size:25px"><i class="glyphicon glyphicon-briefcase"></i>&nbsp Company Data Reactivation
      <hr>
      </h5></center>
      
      <div class= "row">
        <div class="btn-group btn-group-justified">
          <a href="branchreactivation" class="btn btn-info">Branch Details Data Reactivation</a>
          <a href="jobreactivation" class="btn btn-primary">Job Description Data Reactivation</a>
          <a href="empreactivation" class="btn btn-primary">Employee Details Data Reactivation</a>
        </div>
           ...
           <caption></caption>
            <thead>
              <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Last Name: activate to sort column descending" style="width: 249px;">Branch Address</th>
                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Last Name: activate to sort column descending" style="width: 249px;">Telephone Number</th>
                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Last Name: activate to sort column descending" style="width: 249px;">Fax Number</th>
              </tr>
            </thead>
