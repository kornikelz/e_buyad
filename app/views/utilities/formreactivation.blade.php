    ...
    <div class="content-row">  
      ...
      <div class= "row">
        <div class="btn-group btn-group-justified">
          <a href="formreactivation" class="btn btn-info">Form Data Reactivation</a>
          <a href="packreactivation" class="btn btn-primary">Packaging Data Reactivation</a>
        ...
        <div class="col-md-12"><br>
          <table id="example" class="table table-bordered table-hover">
           ...
           <caption></caption>
            <thead>
              <tr role="row">
                <th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Member ID: activate to sort column descending" style="width: 249px;">Form Code</th>
                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Last Name: activate to sort column descending" style="width: 249px;">Form Name</th>
