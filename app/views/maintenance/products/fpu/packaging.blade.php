...
<div class="panel-body">
                <div class="content-row">
                  <center><h5 class="content-row-title" style="font-size:25px">Packaging Maintenance<hr></h5></center>

                  <div class="btn-group btn-group-justified">
                            <a href="forms" class="btn btn-primary">Forms</a>
                            <a href="#" class="btn btn-info">Packaging</a>
                  ...
                  <div class="panel panel-default">
                    <div class = "row">
                      <div class = "col-md-3">
                        <button type="button" class="btn btn-primary btn-block" href="#pack_form" data-toggle="collapse" onclick="clearForm()">ADD PACKAGING</button>
                      </div>
                    </div>
                    <!-- forms -->
                    <div class ="row">
                      ...
                      <div class="col-md-8">
                          <div id="pack_form" class="collapse">
                            <form id = "packform" class="form-horizontal" role="form" method="post">
                            <input type="hidden" name="code" id="code">
                              <div id="namediv" class="form-group has-feedback">
                                <label class = "col-md-2 control-label">Packaging Name:</label>
                                <div class="col-md-10">
                                  <input type="text" placeholder="Packaging Name" id="name" class="form-control" name="name" maxlength="100" required>
                              ...
                              <div class="form-group">
                                <div class="col-md-offset-3 col-md-10">
                                  ...
                                  <button class="btn btn-info" type="cancel" href="#pack_form" data-toggle="collapse" onclick="clearForm()">Cancel</button>
                              </div>
                            </div>
                            </form>
                          </div>
                          ...
                          <div class="panel-body">
                            <table id="example" class="table table-striped table-bordered table-hover dataTable no-footer" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
                                ...
                                <?php
                                                                      							        ...
                                                                      							        $results = DB::select("SELECT * FROM tblpmpackaging WHERE intStatus = 1;");
                                                                                                        ...
                                                                                                        foreach($results as $data){
                                                                                                            ...
                                                                                                            echo '<td class="sorting_1">'.$data->strPMPackCode.'</td>';
                                                                                                            echo '<td>'.$data->strPMPackName.'</td>';
                                                                                                            echo '<td>'.$data->strPMPackDesc.'</td>';
                                                                                                            echo '

                                                                                                                <td align="center">
                                                                                                                  <table>
                                                                                                                    <tr>
                                                                                                                        <button type="button" class="btn btn-success btn-block" href="#pack_form" data-toggle="collapse" onClick="setFormData(\''.
                                                                                                                                                                                                                                                $data->strPMPackCode.'\',\''.
                                                                                                                                                                                                                                                str_replace("'", "@", $data->strPMPackName).'\',\''.
                                                                                                                                                                                                                                                $data->strPMPackDesc
                            ...
                            <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                                  <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                      ...
                                                                      <form method="post" action="{{URL::to('maintenance/fpu/packaging/delete-pack')}}">
...
@section('internal-scripts')
  ...
  <script>//validations
    $("#name").blur(function(){
      if(!isPackNameValid(document.getElementById('name').value)){
        ...
        document.getElementById('namep').innerHTML = '<ul class="list-unstyled"><li style="color:#DA4453">Invalid Packaging Name</li></ul>';
  ...
  <script>//functions
    function setFormData($code, $name, $desc){
	    ...
	    document.getElementById('packform').action = '{{URL::to('/maintenance/fpu/packaging/update-pack')}}';
    }
    function delMessage($code,$name){
	    ...
	    function clearForm(){
	        ...
	        document.getElementById('packform').action = '{{URL::to('/maintenance/fpu/packaging/add-pack')}}';
        document.getElementById('namediv').className = "form-group has-feedback";
        document.getElementById('namespan').className = "glyphicon form-control-feedback";
        document.getElementById('btnsubmit').className = "btn btn-info";
        document.getElementById('namep').innerHTML = '';
